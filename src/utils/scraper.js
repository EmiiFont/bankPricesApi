...
const excelpar = require('./excelParser');
...
const getBancoLafise = async (browser) => {
  try {
    ...
    const dollarSellElement = await page.$(
      '.ng-scope > .lafise-group > .lista:nth-child(1) > .lafise-TasaCambio > .lafise-valorVenta:nth-child(5)',
    );

    const euroBuyElement = await page.$(
      '.ng-scope > .lafise-group > .lista:nth-child(2) > .lafise-TasaCambio > .lafise-valorCompra:nth-child(4)',
    );
