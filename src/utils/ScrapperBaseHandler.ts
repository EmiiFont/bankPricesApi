...
export abstract class ScrapperBaseHandler<T>{
    ...
    protected async getPriceFromSelector(selector: string): Promise<number> {
    ...
    protected async getUSPrices(): Promise<ICurrencyInfo> {
        ...
        return  {symbol: CurrencySymbol.US, buy: buy,
            sell: sell};
    }
    ...
    protected async getEUPrices(): Promise<ICurrencyInfo> {
        ...
        return  {symbol: CurrencySymbol.EU, buy: buy,
            sell: sell};
    }
    ...
    protected async getCHFPrices(): Promise<ICurrencyInfo> {
        ...
        return  {symbol: CurrencySymbol.CHF, buy: buy,
            sell: sell};
    }
    ...
    protected async getCADPrices(): Promise<ICurrencyInfo | undefined> {
        ...
        return  {symbol: CurrencySymbol.CAD, buy: buy,
            sell: sell};
    }
    ...
    protected async getGBPPrices(): Promise<ICurrencyInfo | undefined> {
        ...
        return  {symbol: CurrencySymbol.GBP, buy: buy,
            sell: sell};
    }
    ...
    protected async getPrices(): Promise<IBankPrice> {
        ...
        for (const b of this.currenciesElements) {
            ...
            currencyInfoArr.push({symbol: b.symbol, buy: buy,
                sell: sell})
        }
        ...
        const prices: IBankPrice = {name: this.bankName, dollarBuy: dollar?.buy,
